...
export ALLREDUCE_ALGORITHMS="recursive_doubling_ompi,ring_ompi,ring_segmented_ompi,rabenseifner_ompi,bine_lat_over,bine_bdw_remap_over,bine_bdw_remap_segmented_over"
...
export ALLREDUCE_ALGORITHMS_IS_SEGMENTED="no,no,yes,no,no,no,yes"
